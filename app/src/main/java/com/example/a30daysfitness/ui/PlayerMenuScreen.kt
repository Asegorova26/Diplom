...
@Composable
fun PlayerMenuScreen(navController: NavHostController) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(16.dp),
        ...
        Text(text = "Меню Игрока", style = MaterialTheme.typography.headlineMedium)
        Spacer(modifier = Modifier.height(16.dp))
        Button(onClick = { navController.navigate(Screen.Profile.route) }, modifier = Modifier.fillMaxWidth()) {
            Text("Профиль")
        }
        Spacer(modifier = Modifier.height(16.dp))
        Button(onClick = { /* TODO: Навигация на экран тренировок */ }, modifier = Modifier.fillMaxWidth()) {
            Text("Тренировки")
        }
        Spacer(modifier = Modifier.height(16.dp))
